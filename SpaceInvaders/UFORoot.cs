...
{
    public class UFORoot : GameObject
    {
        public UFORoot(GameObject.Name nameParam, Sprite.Name spriteName, int index, float x, float y, SpriteBatch sBatCol)
